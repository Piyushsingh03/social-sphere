    ...
    return (
        <Form {...form}>
            ...
            <div className="sm:w-420 flex-center flex-col">
                ...
                <p className="text-light-3 small-medium md:base-regular mt-2">To use SocialSphere, please enter your details</p>
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-5 w-full mt-4">
                    ...
                    <p className="text-light-2 text-small-regular text-center  mt-2">Already have an account?
